      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
          {blogPosts.map((post, index) => (
            <Card key={index} className="bg-tech-lightBlue bg-opacity-20 border border-tech-highlight border-opacity-10 backdrop-blur-sm hover:border-opacity-30 transition-all duration-300">
              <CardHeader>
              ...
              <CardFooter className="flex flex-col items-start space-y-4">
                <div className="flex flex-wrap gap-2">
                  {post.tags.map((tag, idx) => (
                    <Badge key={idx} variant="outline" className="bg-transparent text-tech-highlight border-tech-highlight text-xs">
                      {tag}
                    </Badge>
                  ))}
                </div>
        ...
        <div className="flex justify-center">
          <Button
            variant="outline"
            className="border border-tech-highlight text-tech-highlight hover:bg-tech-highlight hover:bg-opacity-10 flex items-center"
          >
