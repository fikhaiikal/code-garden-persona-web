...
const Hero = () => {
  return <section className="min-h-screen flex flex-col justify-center pt-20 px-4">
      <div className="container mx-auto max-w-4xl">
        <p className="font-mono text-tech-highlight mb-5 animate-fade-in">Hi, my name is</p>
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-tech-lightSlate mb-4 animate-fade-in" style={{
        animationDelay: "0.1s"
      }}>Fikri Haikal</h1>
